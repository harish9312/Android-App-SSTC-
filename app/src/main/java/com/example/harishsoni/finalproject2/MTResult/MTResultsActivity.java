...
public class MTResultsActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resCode = sharedPreferences1.getInt("MT",0);
...
try{        String link;
        if(resCode==1)
        {
            link = "http://ssgiedrp.pe.hu/mt1_results.php";
        }
        else
        {
            link = "http://ssgiedrp.pe.hu/mt2_results.php";
        }
...
//        StringBuilder sb = new StringBuilder();
  String res="";
    ...
    public void showJSON(String res) {
        ParseJSONForMTResults parseJSON = new ParseJSONForMTResults(res);
        parseJSON.ParseJSON1();
        ListDataForMT list = new ListDataForMT(this, ParseJSONForMTResults.sub1, ParseJSONForMTResults.sub2,ParseJSONForMTResults.sub3,ParseJSONForMTResults.sub4,ParseJSONForMTResults.sub5,ParseJSONForMTResults.sub6);
