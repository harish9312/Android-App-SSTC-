 ...
 */
public class ListDataForMT extends ArrayAdapter<String> {
    ...
    public ListDataForMT(Context context, String[] sub1, String[] sub2, String[] sub3, String[] sub4, String[] sub5, String[] sub6) {
